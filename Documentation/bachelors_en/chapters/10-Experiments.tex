...
\begin{tabular}{|p{5.5cm}|p{5cm}|}
  ...
  \hline
  \texttt{shilate-mosquitto}         & Up \\
  \hline
  \texttt{shilate-kuksa-databroker}  & Up \\
  \hline
  \texttt{shilate-mqtt-kuksa-feeder} & Up; connected to broker and Kuksa \\
  \hline
  \texttt{shilate-velocitas-app}     & Up; Kuksa databroker channel open \\
  \hline
  \texttt{shilate-leda-controller}   & Up; observation timeout loop until \\
                                     & Unity connects \\
  \hline
\end{tabular}
\end{table}
