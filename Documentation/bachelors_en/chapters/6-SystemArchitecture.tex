...
\footnotesize
\begin{tabular}{|p{7.5cm}|p{3.2cm}|p{2.8cm}|}
  \hline
  \textbf{Topic} & \textbf{Direction} & \textbf{Payload} \\
  \hline
  \nolinkurl{env0/leda/control/steer}    & Python$\to$Unity & float $[-1,1]$ \\
  \hline
  \nolinkurl{env0/leda/control/throttle} & Python$\to$Unity & float $[0,1]$ \\
  \hline
  \nolinkurl{env0/leda/control/brake}    & Python$\to$Unity & float $[0,1]$ \\
  \hline
  \nolinkurl{env0/leda/control/reset}    & Python$\to$Unity & ``1'' \\
  \hline
  \nolinkurl{env0/vehicle/speed}         & Unity$\to$Python & float km/h \\
  \hline
  \nolinkurl{env0/vehicle/training/obs}  & Unity$\to$Python & JSON array \\
  \hline
  \nolinkurl{env0/vehicle/training/reward} & Unity$\to$Python & float \\
  \hline
  \nolinkurl{env0/vehicle/training/done} & Unity$\to$Python & bool \\
  \hline
  \nolinkurl{env0/vehicle/training/episode_end} & Unity$\to$Editor & JSON object \\
  \hline
  \nolinkurl{env0/vehicle/training/heartbeat}    & Unity$\to$Editor & JSON (1 Hz) \\
  \hline
\end{tabular}
\end{table}
