  ...
  \begin{columns}[T]
    \column{0.46\textwidth}
      \begin{tikzpicture}[
        ...
        \node[mqttbox, below=0.20cm of unity] (mqtt)
          {Mosquitto MQTT broker};
        \node[modebox, below=0.55cm of mqtt, xshift=-1.5cm] (python) {%
          \textbf{Python PPO}\\[-1pt]
          {\footnotesize Stable-Baselines3\\Gymnasium env}};
        \node[modebox, below=0.55cm of mqtt, xshift=1.5cm] (leda) {%
          \textbf{Leda SDV}\\[-1pt]
        ...
        \draw[arr] (mqtt.south) -- ++(0,-0.15cm) -| (python.north);
        \draw[arr] (mqtt.south) -- ++(0,-0.15cm) -| (leda.north);
      \end{tikzpicture}
